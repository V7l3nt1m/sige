         ...
         <div class="" id="cadastroalunos">
          <div class="row">
            ...
            <div class="input-group">
              ...
              <div class="form-group">
                <input type="number" class="form-control" id="telefone" value="{{$aluno->telefone_aluno}}" placeholder="Nº de Telefone do aluno ou dos país" name="telefone"  required="required">
                <i class="form-group__bar"></i>
              </div>
          </div>
          <br>
            ...
            <div class="col-md-4">
              <div class="input-group">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control" id="processo_aluno" value="{{$aluno->num_processo}}" placeholder="Nº de Processo do aluno" name="n_processo" data-toggle="tooltip" data-placement="top" title="O ID de inicio de sessão será o nº de processo do aluno"  required="required">
                    <i class="form-group__bar"></i>
                  </div>
              </div>
