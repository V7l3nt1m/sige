...
<h2 align="center">Alterar Informações de Login</h2>
        ...
        <div class="card-demo">
            <div class="card">
                <div class="card-body">
                    <form action="/sige/definições/{{$user->id}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-3">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                                     <div class="form-group">
                                         <input type="text" required name="nome_user" class="form-control" placeholder="Nome de usuário" value="{{ $user->name }}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                   <span class="input-group-addon"><i class="zmdi zmdi-lock"></i></span>
                                    <div class="form-group">
                                        <input type="password" required name="password1" class="form-control" placeholder="Nova Palavra-Passe" data-toggle="tooltip" data-placement="top" title="Se pretende mudar apenas o nome de usuário e manter a mesma senha, digite a senha antiga">
                                        <i class="form-group__bar"></i>
                                    </div>
                                </div>
                            </div>
