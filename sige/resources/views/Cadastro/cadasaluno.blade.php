      ...
      <br>
         ...
         <div class="" id="cadastroalunos">
          ...
          <br>
            ...
            <div class="col-md-4">
              <div class="input-group">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control" id="processo_aluno" placeholder="Nº de Processo do aluno" name="n_processo">
                    <i class="form-group__bar"></i>
                  </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="input-group input-data_nasc">
                  ...
                  <div class="form-group">
                    ...
                    onchange="updatePreview(this, 'image-preview')" onchange="isImagem(this)"  required="required"title="Faça o upload de uma fotografia meio corpo" data-toggle="tooltip" data-placement="top" >
                      <br>
                            ...
                            <br><br>
                              <div class="input-group input-bi">
                                <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                                <div class="form-group">
                                    <input type="text" class="form-control" id="input-field" placeholder="BI ou Nº da Cedula" required="required" name="BI" onkeyup="validate();" data-toggle="tooltip" data-placement="top" title="O BI será o ID de inicio de sessão com a senha Aluno2022">
                                    <i class="form-group__bar"></i>
                                </div>
                            </div>
              </div>
