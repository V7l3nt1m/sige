...
@csrf
    ...
    <div class="col-md-3">
        <div class="input-group">
            ...
            <div class="form-group">
                ...
                id="nome_escola" name="nome_escola" placeholder="Nome da escola" required  data-toggle="tooltip" data-placement="top" title="O ID de inicio de sessão será admin.<nomedaescola> sem espaço e em minusculas">
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="input-group">  
                ...
                <div class="form-group">
                    <input type="text" class="form-control"
                    id="bi" name="n_bi" placeholder="Nº do BI" required onkeyup="bi()"  data-toggle="tooltip" data-placement="top" title="O BI será a palavra-passe do pcaadmin da escola em cadastro">
                </div>
        </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">  
            <select name="contrato" id="contrato" required class="select2" data-minimum-results-for-search="Infinity">
        ...
        <div class="col-md-3">
            <div class="form-group">  
           <select name="pacote" id="Pacote" required class="select2" data-minimum-results-for-search="Infinity">
    ...
    onchange="updatePreview(this, 'image-preview')" onchange="isImagem(this)" width="0px"  required="required"title="Faça o upload da logo da escola" data-toggle="tooltip" data-placement="top" >
        </div>
    </div>

    <div class="row">
        <div class="col-md-6"><input type="submit" class="btn btn-dark" value="Cadastrar escola"></div>
    </div>
...
<script type="text/javascript">
    ...
    <script>
        function bi(){
            fetch(https://angolaapi.herokuapp.com/api/v1/validate/bi/[bi]);
        }
    </script>
