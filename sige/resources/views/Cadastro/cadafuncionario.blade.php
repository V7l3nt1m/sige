                  ...
                  <div class="col-md-4 col-sm-12">
                      ...
                      <div class="input-group">
                        <div class="form-group">
                          <select class="select2" data-minimum-results-for-search="Infinity" name="funcao" required="required">
                              ...
                              <option value="pcaadmin">Director Administrativo</option>
                          </select>
                            <i class="form-group__bar"></i>
                        </div>
                                        </div>
                    ...
                    <div class="col-md-4">
                      <div class="input-group input-bi">
                        <span class="input-group-addon"><i class="zmdi zmdi-account"></i></span>
                        <div class="form-group">
                            <input type="text" class="form-control" id="input-field" placeholder="BI ou Nº da Cedula" required="required" name="BI" onkeyup="validate();" data-toggle="tooltip" data-placement="top" title="O BI será o ID de inicio de sessão com a senha funcionario_2022">
                            <i class="form-group__bar"></i>
                        </div>
                    </div>
                    </div>
