...
<header class="content__title">
    <h1>Lançamento de Notas III Trimestre</h1>
</header>
    ...
    <table style="color: white" class="table table-inverse">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="/professor/trimestreIII/nota/{{$aluno->id}}" method="POST">
                    @csrf
                    @method('PUT')
                            <td>
                                    <div class="input-group">
                                        <div class="form-group">
                                          <input type="number" class="form-control" placeholder="P1" name="p1" value="{{$aluno->t3_p1}}">
                                        </div>
                                    </div>
                            </td>
                            <td>
                                    <div class="input-group">
                                        <div class="form-group">
                                          <input type="number" class="form-control" id="p2" placeholder="P2" name="p2" value="{{$aluno->t3_pf}}">
                                        </div>
                                    </div>
                            </td>
                            <td>
                                    <div class="input-group">
                                        <div class="form-group">
                                          <input type="number" class="form-control" id="mac" placeholder="MAC" name="mac" value="{{$aluno->t3_mac}}">
                                        </div>
                                    </div>
                            </td>
