...
<header class="content__title">
    <h1>Lançamento de Notas Recurso</h1>
</header>
    ...
    <table style="color: white" class="table table-inverse">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="/professor/recurso/nota/{{$aluno->id}}" method="POST">
                    @csrf
                    @method('PUT')
                            <td>
                                    <div class="input-group">
                                        <div class="form-group">
                                          <input type="number" class="form-control" id="p1" placeholder="P1" name="p1" value="{{$aluno->recurso}}">
                                        </div>
                                    </div>
                            </td>
