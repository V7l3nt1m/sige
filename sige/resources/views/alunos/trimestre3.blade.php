...
<div class="card">
    <div class="card-body">
      <h2 class="titulo" align="center">Trimestre III</h2>
...
<div class="row"> 
  <div class="col-md-6">
    @if($nota->t3_p1 < 10)
    <p class="h4">P1: <span class="text-danger">{{$nota->t3_p1}}</span></p>
    @else
    <p class="h4">P1: <span style="color: black">{{$nota->t3_p1}}</span></p>
    @endif
  </div>
  <div class="col-md-6">
    @if($nota->t3_pf < 10)
    <p class="h4">PF: <span class="text-danger">{{$nota->t3_pf}}</span></p>
    @else
    <p class="h4">PF: <span style="color: black">{{$nota->t3_pf}}</span></p>
    @endif
  </div>
</div>
<div class="row"> 
  <div class="col-md-6">
    @if($nota->t3_mac < 10)
    <p class="h4">MAC: <span class="text-danger">{{$nota->t3_mac}}</span></p>
    @else
    <p class="h4">MAC: <span style="color: black">{{$nota->t3_mac}}</span></p>
    @endif
  </div>
  <div class="col-md-6">
    @if($nota->t1_mdf < 10)
