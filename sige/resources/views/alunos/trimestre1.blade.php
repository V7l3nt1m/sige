...
<div class="card">
    <div class="card-body">
      <h2 class="titulo" align="center">Trimestre I</h2>
  <div class="row">
...
<div class="row"> 
  <div class="col-md-6">
    @if($nota->t1_p1 < 10)
    <p class="h4">P1: <span class="text-danger">{{$nota->t1_p1}}</span></p>
    @else
    <p class="h4">P1: <span style="color: black">{{$nota->t1_p1}}</span></p>
    @endif
  </div>
  <div class="col-md-6">
    @if($nota->t1_p2 < 10)
    <p class="h4">P2: <span class="text-danger">{{$nota->t1_p2}}</span></p>
    @else
    <p class="h4">P2: <span style="color: black">{{$nota->t1_p2}}</span></p>
    @endif
  </div>
</div>
<div class="row"> 
  <div class="col-md-6">
    @if($nota->t1_mac < 10)
    <p class="h4">MAC: <span class="text-danger">{{$nota->t1_mac}}</span></p>
    @else
    <p class="h4">MAC: <span style="color: black">{{$nota->t1_mac}}</span></p>
    @endif
  </div>
  <div class="col-md-6">
    @if($nota->t1_mdf < 10)
    <p class="h4">MDF: <span class="text-danger">{{$nota->t1_mdf}}</span></p>
    @else
    <p class="h4">MDF: <span style="color: black">{{$nota->t1_mdf}}</span></p>
    @endif
  </div>
</div>
        </div>
